...
<body class="font-Poppins bg-gray-100 h-screen justify-center">
  <div class="shadow-lg bg-slate-700">
    <?php
    session_start();
  ...
  <div class="">
    ...
    <center class="mt-6">
      <a href="index.php" class="text-gray-500 font-mono text-xl bg-gray-200 p-3 rounded-md hover:shadow-md">Go Home </a>
    </center>
  </div>
</body>
