  ...
  <aside class="inset-y-0 z-10 flex flex-col flex-shrink-0 w-fit max-h-screen overflow-hidden transition-all transform bg-white border-r shadow-lg lg:z-auto lg:static lg:shadow-none">
    ...
    <nav class="flex-1 overflow-hidden hover:overflow-y-auto">
      <ul class="p-2 overflow-hidden">
        <li class="pb-1">
          <a href="dashboard.php" class="flex justify-start items-center p-2 space-x-2 rounded-md <?= ($path == 'dashboard') ? 'bg-gray-100' : 'hover:bg-gray-100' ?>">
            <span>
        ...
        <li class="pb-1">
          <a href="users.php" class="flex justify-start items-center p-2 space-x-2 rounded-md <?= ($path == 'users') ? 'bg-gray-100' : 'hover:bg-gray-100' ?>">
            <span>
        ...
        <li class="pb-1">
          <a href="categories.php" class="flex justify-start items-center p-2 space-x-2 rounded-md <?= ($path == 'categories') ? 'bg-gray-100' : 'hover:bg-gray-100' ?>">
            <span>
              <svg class="w-6 h-6 text-gray-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <li class="pb-1">
          <a href="brands.php" class="flex justify-start items-center p-2 space-x-2 rounded-md <?= ($path == 'brands') ? 'bg-gray-100' : 'hover:bg-gray-100' ?>">
            <span>
              <svg class="w-6 h-6 text-gray-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
        ...
        <li class="pb-1">
          <a href="products.php" class="flex justify-start items-center p-2 space-x-2 rounded-md <?= ($path == 'products') ? 'bg-gray-100' : 'hover:bg-gray-100' ?>">
            <span>
              <svg class="w-6 h-6 text-gray-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
